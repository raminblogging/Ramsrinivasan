...
// All origins allowed to call this API.
// Add any new domains here if you add more frontends.
const ALLOWED_ORIGINS = new Set([
  'https://ramsrinivasan.in',
  'https://www.ramsrinivasan.in',
  'https://personal.ramsrinivasan.in',
]);

function cors(origin) {
  // Reflect the request origin if it's in the allowlist, otherwise default to main site.
  const allowed = ALLOWED_ORIGINS.has(origin) ? origin : 'https://ramsrinivasan.in';
  return {
...
export default {
  async fetch(request, env) {
    ...
    const origin = request.headers.get('Origin') || 'https://ramsrinivasan.in';
